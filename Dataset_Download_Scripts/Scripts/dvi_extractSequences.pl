...
my $genomeId = "GCA_000005245.1";
my $speciesPrefix = "dvi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/005/245/GCA_000005245.1_dvir_caf1/GCA_000005245.1_dvir_caf1_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/005/245/GCA_000005245.1_dvir_caf1/GCA_000005245.1_dvir_caf1_assembly_report.txt";
