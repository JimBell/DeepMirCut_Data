...
my $genomeId = "GCA_000223135.1";
my $speciesPrefix = "cgr";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/223/135/GCA_000223135.1_CriGri_1.0/GCA_000223135.1_CriGri_1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/223/135/GCA_000223135.1_CriGri_1.0/GCA_000223135.1_CriGri_1.0_assembly_report.txt";
