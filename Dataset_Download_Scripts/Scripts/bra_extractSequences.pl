...
my $genomeId = "GCA_000309985.1";
my $speciesPrefix = "bra";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/309/985/GCA_000309985.1_Brapa_1.0/GCA_000309985.1_Brapa_1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/309/985/GCA_000309985.1_Brapa_1.0/GCA_000309985.1_Brapa_1.0_assembly_report.txt";
