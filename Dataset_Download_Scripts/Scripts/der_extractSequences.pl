...
my $genomeId = "dere_r1.3_FB2010_02";
my $speciesPrefix = "der";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.flybase.net/genomes/Drosophila_erecta/dere_r1.3_FB2010_02/fasta/dere-all-chromosome-r1.3.fasta.gz";
