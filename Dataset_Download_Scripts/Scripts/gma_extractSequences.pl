...
my $genomeId = "GCA_000004515.3";
my $speciesPrefix = "gma";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/004/515/GCF_000004515.4_Glycine_max_v2.0/GCF_000004515.4_Glycine_max_v2.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/004/515/GCF_000004515.4_Glycine_max_v2.0/GCF_000004515.4_Glycine_max_v2.0_assembly_report.txt";
...
my($chromNameCol,$chromAliasCol) = (4,6);
my $normalChromNameCol = 2;
my $normalChromNamePrefix = "chr";
my $pref = "NC";
my $chromAliases = getChromAliases_withNormalChromNames_withNormalChromPrefix_pref($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,
										   $normalChromNameCol,$normalChromNamePrefix,$pref);
