...
my $genomeId = "GCA_000241425.1";
my $speciesPrefix = "dma";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/241/425/GCA_000241425.1_DauMad_1.0/GCA_000241425.1_DauMad_1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/241/425/GCA_000241425.1_DauMad_1.0/GCA_000241425.1_DauMad_1.0_assembly_report.txt";
