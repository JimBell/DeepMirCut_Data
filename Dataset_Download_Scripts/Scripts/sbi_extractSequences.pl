...
my $genomeId = "GCA_000003195.3";
my $speciesPrefix = "sbi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/003/195/GCA_000003195.3_Sorghum_bicolor_NCBIv3/GCA_000003195.3_Sorghum_bicolor_NCBIv3_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/003/195/GCA_000003195.3_Sorghum_bicolor_NCBIv3/GCA_000003195.3_Sorghum_bicolor_NCBIv3_assembly_report.txt";
...
my($chromNameCol,$chromAliasCol) = (2,4);
my $prefix = "chr";
my $chromAliases = getChromAliases_chromOnly_appendPrefix($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$prefix);
