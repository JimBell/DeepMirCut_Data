...
my $genomeId = "dgri_r1.3_FB2010_02";
my $speciesPrefix = "dgr";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.flybase.net/genomes/Drosophila_grimshawi/dgri_r1.3_FB2010_02/fasta/dgri-all-chromosome-r1.3.fasta.gz";
