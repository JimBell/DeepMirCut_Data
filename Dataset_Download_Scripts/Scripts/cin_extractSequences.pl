...
my $genomeId = "v2.0";  #from https://genome.jgi.doe.gov/portal/Cioin2/Cioin2.download.ftp.html
my $speciesPrefix = "cin";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.jgi-psf.org/pub/JGI_data/Ciona/v2.0/ciona050324.unmasked.fasta.gz";
my $assemblyInfoFileLocation = "";   #none
...
$assemblyInfoFileLocation = $faiFile;
my($chromNameCol,$chromAliasCol) = (0,0);
my $chromAliases = getChromAliases_ciona($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol);
