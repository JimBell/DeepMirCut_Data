...
my $genomeId = "GCA_000180635.3";
my $speciesPrefix = "ppc";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/180/635/GCA_000180635.3_El_Paco/GCA_000180635.3_El_Paco_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/180/635/GCA_000180635.3_El_Paco/GCA_000180635.3_El_Paco_assembly_report.txt";
