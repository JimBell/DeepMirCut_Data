...
my $genomeId = "GCF_000001545.4";
my $speciesPrefix = "ppy";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/001/545/GCF_000001545.4_P_pygmaeus_2.0.2/GCF_000001545.4_P_pygmaeus_2.0.2_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/001/545/GCF_000001545.4_P_pygmaeus_2.0.2/GCF_000001545.4_P_pygmaeus_2.0.2_assembly_report.txt";
...
my($chromNameCol,$chromAliasCol) = (6,6);
my $normalChromNameCol = 0;
my $normalChromNamePrefix = "chr";
my $pref = "NC";
my $chromAliases = getChromAliases_withNormalChromNames_withNormalChromPrefix_pref($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$normalChromNameCol,$normalChromNamePrefix,$pref);
