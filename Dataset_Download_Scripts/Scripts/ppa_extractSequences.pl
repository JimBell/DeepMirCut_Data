...
my $genomeId = "GCA_000258655.2";
my $speciesPrefix = "ppa";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/258/655/GCA_000258655.2_panpan1.1/GCA_000258655.2_panpan1.1_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/258/655/GCA_000258655.2_panpan1.1/GCA_000258655.2_panpan1.1_assembly_report.txt";
...
my $chromNamePrefix = "chr";
my $chromAliases = getChromAliases_chromOnly_appendPrefix($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$chromNamePrefix);
