...
my $genomeId = "GCA_000241765.2";
my $speciesPrefix = "cpi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/241/765/GCA_000241765.2_Chrysemys_picta_bellii-3.0.3/GCA_000241765.2_Chrysemys_picta_bellii-3.0.3_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/241/765/GCA_000241765.2_Chrysemys_picta_bellii-3.0.3/GCA_000241765.2_Chrysemys_picta_bellii-3.0.3_assembly_report.txt";
...
my $pref = "CM";
my $chromAliases = getChromAliases_withNormalChromNames_pref($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$normalChromNameCol,$pref);
