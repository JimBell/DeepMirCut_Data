...
my $genomeId = "dwil_r1.3_FB2010_02";
my $speciesPrefix = "dwi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.flybase.net/genomes/Drosophila_willistoni/dwil_r1.3_FB2010_02/fasta/dwil-all-chromosome-r1.3.fasta.gz";
