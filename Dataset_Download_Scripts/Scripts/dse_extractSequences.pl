...
my $genomeId = "dsec_r1.3_FB2010_02";
my $speciesPrefix = "dse";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.flybase.net/genomes/Drosophila_sechellia/dsec_r1.3_FB2010_02/fasta/dsec-all-chromosome-r1.3.fasta.gz";
