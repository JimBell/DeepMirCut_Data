...
my $genomeId = "GCA_000317415.1";
my $speciesPrefix = "csi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/317/415/GCA_000317415.1_Csi_valencia_1.0/GCA_000317415.1_Csi_valencia_1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/317/415/GCA_000317415.1_Csi_valencia_1.0/GCA_000317415.1_Csi_valencia_1.0_assembly_report.txt";
...
my $normalChromNamesCol = 0;
my $chromAliases = getChromAliases_withNormalChromNames($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$normalChromNamesCol);
