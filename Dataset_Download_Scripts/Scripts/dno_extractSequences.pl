...
my $genomeId = "Dasypus novemcinctus ";
my $speciesPrefix = "dno";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/208/655/GCA_000208655.2_Dasnov3.0/GCA_000208655.2_Dasnov3.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/208/655/GCA_000208655.2_Dasnov3.0/GCA_000208655.2_Dasnov3.0_assembly_report.txt";
