...
my $genomeId = "GCA_000143925.2";
my $speciesPrefix = "cbn";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/143/925/GCA_000143925.2_C_brenneri-6.0.1b/GCA_000143925.2_C_brenneri-6.0.1b_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/143/925/GCA_000143925.2_C_brenneri-6.0.1b/GCA_000143925.2_C_brenneri-6.0.1b_assembly_report.txt";
...
my($prefix,$replacementPrefix) = ("Scfld02\_","Cbre_Contig");
my $chromAliases = getChromAliases_replacePrefix($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$prefix,$replacementPrefix);
