...
my $genomeId = "GCA_000004255.1";
my $speciesPrefix = "aly";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/004/255/GCA_000004255.1_v.1.0/GCA_000004255.1_v.1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/004/255/GCA_000004255.1_v.1.0/GCA_000004255.1_v.1.0_assembly_report.txt";
