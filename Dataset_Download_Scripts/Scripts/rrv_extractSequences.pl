...
my $genomeId = "AF210726.1";
my $speciesPrefix = "rrv";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = 'https://www.ncbi.nlm.nih.gov/sviewer/viewer.cgi?tool=portal&save=file&log$=seqview&db=nuccore&report=fasta&id=7329990&extrafeat=null&conwithfeat=on';
