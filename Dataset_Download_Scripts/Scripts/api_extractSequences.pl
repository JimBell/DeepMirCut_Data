...
my $genomeId = "GCA_000142985.2";
my $speciesPrefix = "api";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/142/985/GCA_000142985.2_Acyr_2.0/GCA_000142985.2_Acyr_2.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/142/985/GCA_000142985.2_Acyr_2.0/GCA_000142985.2_Acyr_2.0_assembly_report.txt";
