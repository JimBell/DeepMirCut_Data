...
my $genomeId = "OANA5";
my $speciesPrefix = "oan";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ensembl.org/pub/release-95/fasta/ornithorhynchus_anatinus/dna/Ornithorhynchus_anatinus.OANA5.dna_sm.toplevel.fa.gz";
...
sub getChromAliases_replacePrefix {
	...
	unless ( /^\#/ ) {
		...
		#print "$chromName\t$rowData[$chromAliasCol]\n";
	    } else {
