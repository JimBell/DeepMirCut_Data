...
my $genomeId = "GCA_000209225.1";
my $speciesPrefix = "nve";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/209/225/GCA_000209225.1_ASM20922v1/GCA_000209225.1_ASM20922v1_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/209/225/GCA_000209225.1_ASM20922v1/GCA_000209225.1_ASM20922v1_assembly_report.txt";
...
my $chromNamePrefix = "NEMVE";
my $chromAliases = getChromAliases_dropChromNamePrefix($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$chromNamePrefix);
