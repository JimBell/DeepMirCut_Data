...
my $genomeId = "dmoj_r1.3_FB2010_02";
my $speciesPrefix = "dmo";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.flybase.net/genomes/Drosophila_mojavensis/dmoj_r1.3_FB2010_02/fasta/dmoj-all-chromosome-r1.3.fasta.gz";
