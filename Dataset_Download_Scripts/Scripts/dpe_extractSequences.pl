...
my $genomeId = "dper_r1.3_FB2010_02";
my $speciesPrefix = "dpe";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.flybase.net/genomes/Drosophila_persimilis/dper_r1.3_FB2010_02/fasta/dper-all-chromosome-r1.3.fasta.gz";
