...
my $genomeId = "GCA_000004695.1";
my $speciesPrefix = "ddi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/004/695/GCA_000004695.1_dicty_2.7/GCA_000004695.1_dicty_2.7_genomic.fna.gz";
...
#aliases determined from http://dictybase.org/download/gff3/dicty_gff3_10142009.zip
my $chromAliases = {
    "DDB0232428" => "CM000150.2",
    "DDB0232429" => "CM000151.3",
    "DDB0232430" => "CM000152.2",
    "DDB0232431" => "CM000153.2",
    "DDB0232432" => "CM000154.2"
};
