...
my $genomeId = "GCA_000334495.1";
my $speciesPrefix = "tch";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/334/495/GCA_000334495.1_TupChi_1.0/GCA_000334495.1_TupChi_1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/334/495/GCA_000334495.1_TupChi_1.0/GCA_000334495.1_TupChi_1.0_assembly_report.txt";
