...
my $genomeId = "GCA_000005505.1";
my $speciesPrefix = "bdi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/005/505/GCA_000005505.1_v1.0/GCA_000005505.1_v1.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/005/505/GCA_000005505.1_v1.0/GCA_000005505.1_v1.0_assembly_report.txt";
...
my $chromAliases = getChromAliases_chromOnly($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol);
