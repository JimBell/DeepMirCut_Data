...
my $genomeId = "GCA_000317765.2";
my $speciesPrefix = "chi";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/317/765/GCA_000317765.2_CHIR_2.0/GCA_000317765.2_CHIR_2.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/317/765/GCA_000317765.2_CHIR_2.0/GCA_000317765.2_CHIR_2.0_assembly_report.txt";
