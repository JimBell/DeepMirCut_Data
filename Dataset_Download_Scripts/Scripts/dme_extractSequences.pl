...
my $genomeId = "GCA_000001215.4";
my $speciesPrefix = "dme";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/001/215/GCA_000001215.4_Release_6_plus_ISO1_MT/GCA_000001215.4_Release_6_plus_ISO1_MT_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/001/215/GCA_000001215.4_Release_6_plus_ISO1_MT/GCA_000001215.4_Release_6_plus_ISO1_MT_assembly_report.txt";
...
my $normalChromNameCol = 0;
my $normalChromPrefix = "chr";
my $pref = "AE";
my $chromAliases = getChromAliases_withNormalChromNames_withNormalChromPrefix_pref($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$normalChromNameCol,$normalChromPrefix,$pref);
