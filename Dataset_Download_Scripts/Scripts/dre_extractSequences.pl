...
my $genomeId = "GCA_000002035.4";
my $speciesPrefix = "dre";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/002/035/GCA_000002035.4_GRCz11/GCA_000002035.4_GRCz11_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/002/035/GCA_000002035.4_GRCz11/GCA_000002035.4_GRCz11_assembly_report.txt";
...
my $normalChromCol = 9;
my $pref = "CM";
my $chromAliases = getChromAliases_withNormalChromNames_pref($assemblyInfoFileLocation,$gDir,$chromNameCol,$chromAliasCol,$normalChromCol,$pref);
