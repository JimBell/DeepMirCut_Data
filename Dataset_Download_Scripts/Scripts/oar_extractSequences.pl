...
my $genomeId = "GCA_000298735.2";
my $speciesPrefix = "oar";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/298/735/GCA_000298735.2_Oar_v4.0/GCA_000298735.2_Oar_v4.0_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCA/000/298/735/GCA_000298735.2_Oar_v4.0/GCA_000298735.2_Oar_v4.0_assembly_report.txt";
...
my($chromNameCol,$chromAliasCol) = (9,4);
