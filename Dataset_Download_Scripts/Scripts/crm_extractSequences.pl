...
my $genomeId = "WS200"; #wormbase
my $speciesPrefix = "crm";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.wormbase.org/pub/wormbase/releases/WS200/species/c_remanei/c_remanei.WS200.genomic.fa.gz";
