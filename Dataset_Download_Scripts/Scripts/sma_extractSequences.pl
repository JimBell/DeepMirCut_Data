...
my $genomeId = "WTSI5";
my $speciesPrefix = "sma";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.sanger.ac.uk/pub/project/pathogens/Schistosoma/mansoni/Archive/S.mansoni/genome/Assembly-v5/sma_v5.0.chr.fa.gz";
...
my $prefix = 'Schisto_mansoni.';
my $chromAliases = getChromAliases_dropChromNamePrefix($faiFile,$gDir,$chromNameCol,$chromAliasCol,$prefix);
$chromAliases->{"Chr_W"} = "Schisto_mansoni.Chr_ZW";
