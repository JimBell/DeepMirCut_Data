...
my $genomeId = "X17403.1";
my $speciesPrefix = "hcmv";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "https://www.ncbi.nlm.nih.gov/sviewer/viewer.cgi?tool=portal&save=file&log$=seqview&db=nuccore&report=fasta&id=59591&extrafeat=null&conwithfeat=on";
