...
my $genomeId = "GCF_000002295.2";
my $speciesPrefix = "mdo";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/002/295/GCF_000002295.2_MonDom5/GCF_000002295.2_MonDom5_genomic.fna.gz";
my $assemblyInfoFileLocation = "ftp://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/002/295/GCF_000002295.2_MonDom5/GCF_000002295.2_MonDom5_assembly_report.txt";
...
my $chromAliases = getChromAliases_withNormalChromNames_withNormalChromPrefix($assemblyInfoFileLocation,$gDir,$chromNameCol,
									      $chromAliasCol,$normalChromNameCol,$normalChromNamePrefix);
