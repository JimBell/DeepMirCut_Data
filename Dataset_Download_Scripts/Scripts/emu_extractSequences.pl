...
my $genomeId = "WTSI3";
my $speciesPrefix = "emu";
my $miRBaseGff = "$speciesPrefix\.gff3";
my $genomeFileLocation = "ftp://ftp.sanger.ac.uk/pub/project/pathogens/Echinococcus/multilocularis/genome/Emultilocularis_genome_v3.fas";
...
my $prefix = "pathogen_EMU_";
my $replacementPrefix = "";
my $chromAliases = getChromAliases_replacePrefix($faiFile,$gDir,$chromNameCol,$chromAliasCol,$prefix,$replacementPrefix);
